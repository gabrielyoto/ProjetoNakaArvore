...
int main ()
{
    int choice, num, arvore, busca, folhas, same;
    no *raiz = NULL;
    no *raiz2 = NULL;
    no* inicio;
    int h;
        ...
        switch (choice)
        {
           ...
           case 5:
            ...
            case 10:
                ...
                break;
            case 11:
                cont_total = contagem(no *raiz);
                printf("\n Número total de nós é de %d \n", cont_total);
                if(arvore==2)
                {
                    cont_total = contagem(no *raiz2);
                    printf("\n Número total de nós é de %d \n", cont_total);
                }
                break;
            case 12:
                ...
                scanf("%d", busca);
                pertence(no *raiz, busca);
                if(arvore ==2)
                {
                    printf("\nQual valor deseja buscar?\n");
                    scanf("%d", busca);
                    pertence(no *raiz2, busca);
                }
                break;
            case 13:
                folhas = cont_folhas(no *raiz);
                printf("\n Número de nós folhas é %d \n", folhas);
                if(arvore=2)
                {
                    folhas = cont_folhas(no *raiz2);
                    printf("\n Número de nós folhas é %d \n", folhas);
                }
                break;
            case 14:
                same = iguais(no *raiz, no *raiz2)
                if(same=1)
                {
